...
function addToCartClicked(event) {
    ...
    var title = shopItem.getElementsByClassName('col-4 h4')[0].innerText
    var price = shopItem.getElementsByClassName('cal-4 p')[0].innerText
    var imageSrc = shopItem.getElementsByClassName('col-4 img')[0].src
